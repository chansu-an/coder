        ...
        <form method="post"  class="needs-validation" enctype="multipart/form-data" novalidate>
          <div class="row g-3">
            <div class="col-md-6">
              ...
              <input type = "text" class="form-control" name="NAME" id="NAME" value="${map.NAME }" placeholder="이름">
              </div>
               <div class="col-md-6">
              ...
              <input type="text" class="form-control" name="SKILL" id="SKILL" value="${map.SKILL }" placeholder="예:java,javascript...">
              </div>
            </div>
            <div class="col-md-6">
              <label for="TELL" class="form-label">전화번호</label>
               <input type="text" class="form-control" name="TELL" id="TELL" value="${map.TELL }" placeholder="전화번호">
            </div>
            <div class="col-md-6">
              <label for="email" class="form-label">이메일</label>
               <input type="text" class="form-control" name="EMAIL" id="EMAIL" value="${map.EMAIL }" placeholder="이메일">
            </div>
            <div class="col-md-6">
              <label for="BLOG" class="form-label">포트폴리오</label>
               <input type="URL" class="form-control" name="BLOG" id="BLOG" value="${map.BLOG }" placeholder="포트폴리오" >
            </div>
            <div class="col-md-6">
