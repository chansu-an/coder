						...
						<div class="card">
							...
							<div align="right">
								<a href="../Project/ProjectS.do" class="btn">시작예정</a> <a
									...
									href="../Project/ProjectE.do" class="btn">종료 <svg
										xmlns="http://www.w3.org/2000/svg" width="16" height="16"
										fill="currentColor" class="bi bi-calendar2-x"
										viewBox="0 0 16 16">
  <path
													...
													<c:when test="${fn:length(list2) > 0}">
														...
														<c:forEach items="${list2 }" var="row">
															<tr>
																...
																<td><a
																	href="../Project/Detail.do?PROJECT_NO=${row.PROJECT_NO }&USER_NO=${session.USER_NO}&END=end">${row.PROJECT_NAME}</a>
