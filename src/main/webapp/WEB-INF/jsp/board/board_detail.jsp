  ...
  <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM8 4a.905.905 0 0 0-.9.995l.35 3.507a.552.552 0 0 0 1.1 0l.35-3.507A.905.905 0 0 0 8 4zm.002 6a1 1 0 1 0 0 2 1 1 0 0 0 0-2z"/>
	...
	<section class="mb-5">
      <div class="card bg-light">
		<div id="reply">
		  <div class="card-header"><i class="far fa-comment-dots"></i> 댓글 <c:out value="${count}"></c:out></div>	    
		</div>
        <div class="card-body">
        	<!-- Single comment-->
           <c:if test="${bestcomment.RECOMMAND_COUNT != null }">
           <div class="d-flex">
              <div class="flex-shrink-0"><i class="fas fa-star fa-lg" style="color:currentcolor"></i></div>
                  <div class="ms-3">
           ...
           <br/> 
		    ...
		    <div align="center">
					<c:if test="${pmap.startpag>1}">
						<a href="../board/detail.do?IDENTI_TYPE=${param.IDENTI_TYPE }&BOARD_NO=${param.BOARD_NO }&PAG_NUM=${pmap.startpag-2}">이전</a>
					</c:if>
					...
					<c:if test="${pmap.endpage<pmap.maxpag}">
						<a href="../board/detail.do?IDENTI_TYPE=${param.IDENTI_TYPE }&BOARD_NO=${param.BOARD_NO }&PAG_NUM=${pmap.startpag+2}">다음</a>
					</c:if>
			</div>
        </div>
      </div>
